...
namespace NLog.Targets.Splunk
{
    ...
    public sealed class SplunkHttpEventCollector : TargetWithContext
    {
        ...
        /// <summary>
        /// Gets or Sets whether to use the URL as is
        /// Default is false = appends 
        /// </summary>
        public bool UseUrlAsIs { get; set; } = false;
        ...
        protected override void Write(LogEventInfo logEventInfo)
        {
            ...
            _hecSender.Send(logData: logEventInfo.Message);
