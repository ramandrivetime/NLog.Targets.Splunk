...
namespace Splunk.Logging
{
    ...
    public class HttpEventCollectorSender : IDisposable
    {
        ...
        /// <param name="useUrlAsIs">by default appends /services/collector/event/1.0 to the url. If true uses the incoming url as is </param>
        /// <remarks>
        ...
        public HttpEventCollectorSender(
            ...
            bool useUrlAsIs = false)
        {
            NLog.Common.InternalLogger.Debug("Initializing Splunk HttpEventCollectorSender");

            this.httpEventCollectorEndpointUri = new Uri(uri, (useUrlAsIs ? String.Empty : HttpEventCollectorPath));
